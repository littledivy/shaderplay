var Module = function (Module) {
  ...
  function __addDays(date, days) {
    ...
    while (days > 0) {
      ...
      var daysInCurrentMonth =
        (leap ? __MONTH_DAYS_LEAP : __MONTH_DAYS_REGULAR)[currentMonth];
    ...
    var EXPANSION_RULES_2 = {
      ...
      "%V": function (date) {
        ...
        if (!val) {
          ...
          if (
            dec31 == 4 || dec31 == 5 && __isLeapYear(date.tm_year % 400 - 1)
          ) val++;
        } else if (val == 53) {
  ...
  var _spirv_to_wgsl = Module["_spirv_to_wgsl"] = function () {
    return (_spirv_to_wgsl = Module["_spirv_to_wgsl"] = Module["asm"]["r"])
